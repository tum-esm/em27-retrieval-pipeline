...
module glob_OPUSparms62

use glob_prepro62,only : maxmeas,maxOPUSchar
...
!    ' PGN - preamp gain
!    ' SGN - signal gain
!    ' SG2 - signal gain chan2
!    ' PGN, SGN, and SG2 are character variables, integer values are stored as nPGN,nSGN, and nSG2
...
type OPUS_parameters
    ...
    character(len=maxOPUSchar) :: PGN ! pregain
    character(len=maxOPUSchar) :: SGN ! signal gain
    character(len=maxOPUSchar) :: SG2 ! signal gain 2nd channel
    integer :: nPGN                   ! pregain 0,1,2,3
    integer :: nSGN                   ! gain 1,2,4,8,16
    integer :: nSG2                   ! gain 2nd channel 1,2,4,8,16 
