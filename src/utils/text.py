...
adjectives = [
    'admiring', 'adoring', 'affectionate', 'agitated', 'amazing', 'ambitious', 'amused', 'angry',
    'astonished', 'audacious', 'awesome', 'backstabbing', 'beautiful', 'berserk', 'big', 'blissed',
    'blissful', 'bohemian', 'bold', 'boring', 'brave', 'bubbly', 'busy', 'captivating', 'caring',
    'charming', 'clever', 'compassionate', 'competent', 'condescending', 'confident', 'cool',
    'courageous', 'cranky', 'crazy', 'daring', 'dazzling', 'deadly', 'determined', 'distracted',
    'dreamy', 'dynamic', 'eager', 'eccentric', 'ecstatic', 'elastic', 'elated', 'elegant',
    'eloquent', 'enchanting', 'epic', 'exciting', 'fearless', 'fervent', 'festive', 'flamboyant',
    'focused', 'friendly', 'frosty', 'funny', 'gallant', 'generous', 'gifted', 'goofy', 'gracious',
    ...
    'quirky', 'quizzical', 'recursing', 'relaxed', 'reverent', 'romantic', 'ruthless', 'sad',
    'savage', 'serene', 'sharp', 'silly', 'sleepy', 'spiritual', 'stoic', 'strange', 'stupefied',
    'suspicious', 'sweet', 'tender', 'thirsty', 'trusting', 'unruffled', 'upbeat', 'vibrant',
    'vigilant', 'vigorous', 'wizardly', 'wonderful', 'wondering', 'xenodochial', 'youthful',
    'zealous', 'zen'
]
...
names = [
    ...
    "cannon", "carson", "cartwright", "carver", "cerf", "chandrasekhar", "chaplygin", "chatelet",
    "chatterjee", "chaum", "chebyshev", "clarke", "cohen", "colden", "cori", "cray", "curie",
    "curran", "darwin", "davinci", "dewdney", "dhawan", "diffie", "dijkstra", "dirac", "driscoll",
    ...
    "haslett", "hawking", "heisenberg", "hellman", "hermann", "herschel", "hertz", "heyrovsky",
    ...
    "lalande", "lamarr", "lamport", "leakey", "leavitt", "lederberg", "lehmann", "lewin",
    "lichterman", "liskov", "lovelace", "lumiere", "mahavira", "margulis", "matsumoto", "maxwell",
    "mayer", "mccarthy", "mcclintock", "mclaren", "mclean", "mcnulty", "meitner", "mendel",
    "mendeleev", "meninsky", "merkle", "mestorf", "mirzakhani", "montalcini", "moore", "morse",
    "moser", "murdock", "napier", "nash", "neumann", "newton", "nightingale", "nobel", "noether",
    ...
    "satoshi", "shamir", "shannon", "shaw", "shirley", "shockley", "shtern", "sinoussi", "snyder",
    "solomon", "spence", "stonebraker", "sutherland", "swanson", "swartz", "swirles", "taussig",
    "tesla", "tharp", "thompson", "torvalds", "tu", "turing", "varahamihira", "vaughan", "villani",
    "visvesvaraya", "volhard", "wescoff", "wilbur", "wiles", "williams", "williamson", "wilson",
