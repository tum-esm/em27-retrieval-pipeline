...
<img
  src="docs/public/images/architecture.png"
  alt="Architecture of the EM27 Retrieval Pipeline"
  width={3033}
  height={2166}
  className="my-8 max-w-lg mx-auto w-full p-2 md:p-4 bg-white rounded"
/>

## Getting started

Please visit the [Quick Start Guide](https://tum-esm.github.io/em27-retrieval-pipeline/guides/quick-start) to install the pipeline on your system and run the example. You can look into the API Reference pages for an exact schema definition and explanation of every parameter. You can also use the documentation's search function (top navbar) to find what you are looking for.

## All features of this pipeline
...
Have a look at the [Developer Guides](https://tum-esm.github.io/em27-retrieval-pipeline/developer-guides/contributing) for more information regarding the development of this pipeline.
