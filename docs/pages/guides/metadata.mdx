...
We use this metadata in many places: for plotting, data analysis, calibration factor computation, and so on. You do not have to rewrite the parsing logic for every single project but can use our `em27-metadata` Python library: [github.com/tum-esm/em27-metadata](https://github.com/tum-esm/em27-metadata).
