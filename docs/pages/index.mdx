...
* The [configuration section](/guides/configuration) explains, how the pipeline uses a `config.json` file to read in the parameters of your environment.
...
* The [metadata section](/guides/metadata) explains, what the metadata the pipeline required is structured, and how you can connect it to the pipeline.
...
Once you have read the sections above, you are read to use the pipeline. The [usage section](/guides/usage) explains how to run the pipeline.
