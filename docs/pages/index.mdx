...
Furthermore, this pipeline will continue to include support for the different retrieval algorithms. We might reserve advanced features - like the export - for newer retrieval algorithms/versions, but keeping the support for old ones is little effort with our architecture.
