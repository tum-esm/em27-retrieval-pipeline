...
function CodePanelHeader(props: { title: string }) {
  return (
...
function CodePanel(props: {
  ...
  return (
    <div className="group dark:bg-white/2.5">
      {props.title !== undefined && <CodePanelHeader title={props.title} />}
      <div className="relative">
        <div className="overflow-x-auto p-4 text-xs text-white">
          {props.children}
        </div>
...
export function Pre(props: any) {
  console.log(props)
  return (
    <pre className="not-prose my-6 overflow-hidden rounded-2xl bg-zinc-900 shadow-md dark:ring-1 dark:ring-white/10">
      <CodePanel {...props}>
        <code
