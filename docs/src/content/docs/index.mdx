...
<img
  src="/em27-retrieval-pipeline/images/architecture.png"
...
**Opinionated management of station metadata:** We manage our EM27 metadata using TOML files, described [here](/em27-retrieval-pipeline/guides/em27-metadata) and with a full schema reference [here](/em27-retrieval-pipeline/reference/em27-metadata)
