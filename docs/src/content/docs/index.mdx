...
<div className="flex flex-row items-start flex-wrap gap-1">
  ...
  <img
    alt="Static Badge"
    src="https://img.shields.io/badge/GGG2014%20%7C%20GGG2020%20-%20whydoineedthis?style=flat&label=Atmospheric%20Profile%20Models&labelColor=%230f172a&color=%2399f6e4&cacheSeconds=60" className="inline !p-0 !m-0"
  />
  <a 
    href="https://doi.org/10.5281/zenodo.14284968"
    target="_blank"
  >
    <img
      alt="Static Badge"
