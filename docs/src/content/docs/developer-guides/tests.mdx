...
The `ci` and `complete` tests use the sample interferograms, pressure data, and atmospheric profiles under `example/data/inputs`. Generated retrieval results are written to `data/testing/outputs/individual-results`.
