...
The [API Reference section](/em27-retrieval-pipeline/reference/em27-metadata) contains a full example file for the metadata as well as a complete specification of the schema.
