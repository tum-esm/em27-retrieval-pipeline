...
The [API Reference section](/em27-retrieval-pipeline/reference/metadata) contain an full example file for the metadata as well as a complete specification of the schema.
