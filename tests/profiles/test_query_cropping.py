...
def test_get_date_suffixes(provide_config_template: custom_types.Config) -> None:
    ...
    queries = [
        DownloadQuery(from_date="2000-01-01", to_date="2000-01-01", lat=0, lon=0),
        DownloadQuery(from_date="2000-01-01", to_date="2000-01-03", lat=0, lon=0),
        DownloadQuery(from_date="2000-01-01", to_date="2000-01-04", lat=0, lon=0),
        DownloadQuery(from_date="2000-01-03", to_date="2000-01-06", lat=0, lon=0),
    ...
    expected_responses: dict[
        ...
        5: {
            "GGG2014": [
                ...
                ["20000101_20000103"],
                ["20000101_20000104"],
                ["20000103_20000106", "20000103_20000105", "20000103_20000104"],
                ["20000105_20000106", "20000105_20000105"],
            ],
            "GGG2020": [
                ["20000101-20000102"],
                ["20000101-20000104"],
                ["20000101-20000105"],
                ["20000103-20000107", "20000103-20000106", "20000103-20000105"],
                ["20000105-20000107", "20000105-20000106"],
            ],
        },
        7: {
            "GGG2014": [
                ["20000101_20000101"],
                ["20000101_20000103", "20000101_20000102"],
                ["20000101_20000104", "20000101_20000103", "20000101_20000102"],
                [
                    "20000103_20000106",
                    "20000103_20000105",
                    "20000103_20000104",
            ...
            "GGG2020": [
                ["20000101-20000102"],
                ["20000101-20000104", "20000101-20000103"],
                ["20000101-20000105", "20000101-20000104", "20000101-20000103"],
                [
                    "20000103-20000107",
                    "20000103-20000106",
                    "20000103-20000105",
